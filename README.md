...
- **Docker:** Run ROS 2 inside a container.
...
- [Install Docker on Ubuntu](https://docs.docker.com/engine/install/ubuntu/), then the [post-install steps](https://docs.docker.com/engine/install/linux-postinstall/) to run without `sudo`
...
The robot runs **ROS 2 Foxy**. Use the [LIMO Pro ROS 2 Foxy manual](https://github.com/agilexrobotics/limo_pro_doc/blob/master/Limo%20Pro%20Ros2%20Foxy%20user%20manual%28EN%29.md) ([Chinese edition](https://github.com/agilexrobotics/limo_pro_doc)). Study in order:
